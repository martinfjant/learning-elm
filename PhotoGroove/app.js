...
var $author$project$PhotoGroove$initialModel = {activity: '', chosenSize: $author$project$PhotoGroove$Medium, hue: 5, noise: 5, ripple: 7, selectedUrl: '1.jpeg', status: $author$project$PhotoGroove$Loading};
var $author$project$PhotoGroove$init = function (flags) {
	var activity = 'Initialising Pasta v' + $elm$core$String$fromFloat(flags);
